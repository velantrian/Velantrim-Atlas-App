...
import { a as Heart, l as Brain, n as ShieldCheck, o as Database, s as Compass, u as ArrowUpRight } from "../_libs/lucide-react.mjs";
import { a as cn, i as Button, n as t, r as useI18n } from "./router-3ss9daO1.mjs";
import { f as memoryTiers, n as admitRoles, p as planes, r as antiDegradation, u as genomeScenarios, v as specialists } from "./atlas-data-fcAQLGB7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/cognitive-os-CK2qXkBd.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chip, { children: lang === "ru" ? "Пользователь" : "User" }),
				...
				planes.filter((p) => p.id !== "memory").map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					p.id === "control" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Spine, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: specialists.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chip, { children: lang === "ru" ? "Интерпретация → человек" : "Interpretation → human" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Spine, {}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: lang === "ru" ? "Memory" : "Memory"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "grid size-10 place-items-center rounded-md border border-accent/40 text-accent",
...
function PlaneNode({ n, name, question, on, onClick }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: lang === "ru" ? "Пять сотрудничающих плоскостей. Человеческое присутствие и инженерная сила измеряются отдельно. Модель принимается в роль, а не глобально. Система переживает замену бэкенда." : "Five cooperating planes. Human presence and engineering power are measured separately. A model is admitted by role, not globally. The system survives backend replacement."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-display text-2xl tracking-tight",
						children: lang === "ru" ? "Behavioral Museum" : "Behavioral Museum"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-display text-2xl tracking-tight",
						children: lang === "ru" ? "Local-first" : "Local-first"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-sm leading-relaxed text-muted",
						children: lang === "ru" ? "Interaction остаётся на устройстве. В облако уходит sanitised task. Сырое решение возвращается локальной модели, которая говорит с человеком. Провайдер заменяем." : "Interaction stays on-device. The cloud receives a sanitized task. The raw solution returns to the local model that speaks to the human. The provider is replaceable."
					})]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: lang === "ru" ? "Anti-degradation" : "Anti-degradation"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
