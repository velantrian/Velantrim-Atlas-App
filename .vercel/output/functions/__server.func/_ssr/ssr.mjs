...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B_HN1CVW.mjs");
...
var manifest = { "3cadf769414460f842f4a8055c12be0f0d535df83db8cc473d6499d7bee8f3eb": {
	functionName: "speakAltair_createServerFn_handler",
	importer: () => import("./speak-DlpXt_GV.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-0sfaDV0d.mjs").then((n) => n.t),
