...
var projects = [
	...
	},
	{
		id: "clos",
		name: {
			ru: "Cognitive Life OS",
			en: "Cognitive Life OS"
		},
		map: {
			ru: "CLOS",
			en: "CLOS"
		...
		status: {
			ru: "research blueprint",
			en: "research blueprint"
		},
...
var planes = [
	{
		...
		duties: [
			{
				ru: "намерение и прагматика диалога",
				en: "intent and conversational pragmatics"
			},
			{
				ru: "эмоциональная калибровка без терапии по умолчанию",
				en: "emotional calibration without default therapy"
			},
			{
				ru: "юмор, ирония, callbacks, timing",
				en: "humor, irony, callbacks, timing"
			},
			{
				ru: "семантический handoff в машинную спецификацию",
				en: "semantic handoff into a machine specification"
			},
			{
				ru: "перевод технического вывода обратно в смысл",
				en: "translating technical output back into meaning"
			}
		]
	},
	{
		...
		duties: [
			{
				ru: "роль и семейство модели",
				en: "model role and family"
			},
			{
				ru: "лестница усилия: Low → Max",
				en: "effort ladder: Low → Max"
			},
			{
				ru: "стратегия: direct / CoT / ReAct / plan-execute",
				en: "strategy: direct / CoT / ReAct / plan-execute"
			},
			{
				ru: "privacy boundary и latency/cost",
				en: "privacy boundary and latency/cost"
			},
			{
				ru: "смена стратегии после провала",
				en: "strategy switch after failure"
			}
		]
	},
	{
		...
		duties: [
			{
				ru: "стратегическое рассуждение",
				en: "strategic reasoning"
			},
			{
				ru: "код и отладка",
			...
			{
				ru: "исследование и документы",
				en: "research and documents"
			},
			{
				ru: "инструменты и компьютер",
				en: "tools and computer use"
			},
			{
				ru: "локальные / приватные воркеры",
				en: "local / private workers"
			}
		]
	},
	{
		...
		duties: [
			{
				ru: "тесты, компилятор, static analysis",
				en: "tests, compiler, static analysis"
			},
			{
				ru: "source-backed фактические проверки",
				en: "source-backed factual checks"
			},
			{
				ru: "независимый cross-family review",
				en: "independent cross-family review"
			},
			{
				ru: "policy и constraint checks",
				en: "policy and constraint checks"
			},
			{
				ru: "evidence, не язык уверенности",
				en: "evidence, not confidence language"
			}
		]
	},
	{
		...
		duties: [
			{
				ru: "модель пользователя и состояние задачи",
				en: "user model and task state"
			},
			{
				ru: "эпизоды, факты, provenance",
				en: "episodes, facts, provenance"
			},
			{
				ru: "Hot / Warm / Cold",
				en: "Hot / Warm / Cold"
			...
			{
				ru: "preference ≠ fact, belief ≠ fact",
				en: "preference ≠ fact, belief ≠ fact"
			},
			{
				ru: "анти-деградация: drift, loops, sycophancy",
				en: "anti-degradation: drift, loops, sycophancy"
			}
		]
	}
];
var memoryTiers = [
	{
		...
		body: {
			ru: "Активный рабочий контекст.",
			en: "Active working context."
		}
	},
	{
		id: "warm",
	...
	},
	{
		...
		body: {
			ru: "Полный архив / forensic history.",
			en: "Full archive / forensic history."
		}
	}
];
var distinctions = [
	...
	},
	{
		...
		note: {
			ru: "Утверждение ≠ убеждение системы.",
			en: "A claim is not a system belief."
		}
	},
	{
		left: {
	...
	},
	{
		...
		right: {
			ru: "evidence strength",
			en: "evidence strength"
		},
		note: {
			ru: "Уверенность модели — не сила доказательства.",
			en: "Model confidence is not evidence strength."
		}
	},
	{
		left: {
		...
		note: {
			ru: "Связность может быть ложной.",
			en: "Coherence can be false."
		}
	},
	{
		left: {
		...
		note: {
			ru: "Непрерывность «я» не даёт права действовать.",
			en: "Continuity of self does not grant permission to act."
		}
	},
	{
		left: {
	...
	},
	{
		...
		note: {
			ru: "Исследовательский результат не становится законом.",
			en: "A research result does not become law."
		}
	},
	{
		left: {
	...
	},
	{
		...
		note: {
			ru: "Вывод модели не является каноном.",
			en: "Model output is not Canon."
		}
	},
	{
		left: {
		...
		note: {
			ru: "R ≠ S ≠ T ≠ U ≠ A. Присутствие в контексте ≠ вклад в ответ.",
			en: "R ≠ S ≠ T ≠ U ≠ A. Context presence ≠ contribution."
		}
	},
	{
		left: {
		...
		note: {
			ru: "Модель ≠ система. Система переживает замену модели.",
			en: "Model ≠ system. The system survives model replacement."
		}
	}
];
var closCycle = [
	{
		...
		ask: {
			ru: "Что существует вне системы — мир, себя, другие.",
			en: "What exists outside the system — world, self, others."
		}
	},
	{
		id: "perception",
		...
		ask: {
			ru: "Что произошло? Что действительно наблюдалось?",
			en: "What happened? What was actually observed?"
		}
	},
	{
		id: "epistemics",
		...
		ask: {
			ru: "Источник, представление, утверждение, свидетельство, неизвестность.",
			en: "Source, representation, claim, evidence, unknown."
		}
	},
	{
		id: "memory",
		...
		ask: {
			ru: "Что сохранить? Что изменилось? Откуда это известно?",
			en: "What to keep? What changed? How is this known?"
		}
	},
	{
		id: "self",
		...
		ask: {
			ru: "Кто я в этом контексте? Во что верю? Какие обязательства?",
			en: "Who am I in this context? What do I believe? Which obligations?"
		}
	},
	{
		id: "will",
		...
		ask: {
			ru: "Чего пытаюсь достичь? Что допустимо менять?",
			en: "What am I trying to reach? What am I allowed to change?"
		}
	},
	{
		id: "thought",
		...
		ask: {
			ru: "Понять, предположить, сравнить, проверить, спланировать.",
			en: "Understand, hypothesize, compare, test, plan."
		}
	},
	{
		id: "decision",
		...
		ask: {
			ru: "Достаточно ли известно? Есть ли полномочие? Или STOP.",
			en: "Is enough known? Is there authority? Or STOP."
		}
	},
	{
		id: "action",
		...
		ask: {
			ru: "Выполнить bounded действие — или отказаться.",
			en: "Perform a bounded action — or refuse."
		}
	},
	{
		id: "consequence",
		...
		ask: {
			ru: "Что произошло на самом деле, а не что ожидалось?",
			en: "What actually happened, not what was expected?"
		}
	},
	{
		id: "revision",
		...
		ask: {
			ru: "Что пересмотреть в знаниях, стратегии, модели себя — без тихой перезаписи.",
			en: "What to revise in knowledge, strategy, self-model — without silent overwrite."
		}
	}
];
var admissionSteps = [
	{
		ru: "Candidate / Proposal",
	...
	{
		ru: "Проверка целевого домена",
		en: "Target-domain validation"
	},
	{
		ru: "DENY → Decision Receipt",
		en: "DENY → Decision Receipt"
	},
	{
		ru: "ALLOW → CapabilityLease",
		en: "ALLOW → CapabilityLease"
	},
	{
		ru: "Bounded operation",
		en: "Bounded operation"
	},
	{
		ru: "ConsumptionReceipt",
		en: "ConsumptionReceipt"
	}
];
var formula = {
...
function routeTask(raw) {
	const s = raw.toLowerCase();
	const has = (...keys) => keys.some((k) => s.includes(k));
	if (has("rust", "код", "code", "bug", "debug", "compile", "borrow", "refactor", "api", "тест", "test")) return {
		role: {
			ru: "Coder",
			en: "Coder"
		},
		family: {
			ru: "capability specialist",
			en: "capability specialist"
		},
		effort: has("тест", "test", "critical", "продакшн", "production") ? "XHigh" : "High",
		strategy: {
			ru: "plan-execute + tests",
			en: "plan-execute + tests"
		},
		verifier: {
			ru: "compiler / tests / independent review",
			en: "compiler / tests / independent review"
		},
		privacy: {
			ru: "sanitize before cloud",
			en: "sanitize before cloud"
		},
		memory: {
			ru: "task invariants + warm trajectory",
			en: "task invariants + warm trajectory"
		},
		plane: "capability",
		note: {
	...
	if (has("медицин", "medical", "claim", "утвержд", "evidence", "источник", "source", "legal", "факт")) return {
		role: {
			ru: "Researcher",
			en: "Researcher"
		},
		family: {
			ru: "capability + assurance",
			en: "capability + assurance"
		},
		effort: "XHigh",
		strategy: {
			ru: "source-backed + adversarial review",
			en: "source-backed + adversarial review"
		},
		verifier: {
			ru: "независимый fact-check, не self-review",
			en: "independent fact-check, not self-review"
		},
		privacy: {
			ru: "high — no silent external leak",
			en: "high — no silent external leak"
		},
		memory: {
			ru: "typed facts with provenance",
			en: "typed facts with provenance"
		},
		plane: "assurance",
		note: {
	...
	if (has("агент", "agent", "многошаг", "multi-step", "orchestr", "план исслед", "репозитор")) return {
		role: {
			ru: "Long-horizon operator",
			en: "Long-horizon operator"
		},
		family: {
			ru: "control + capability",
			en: "control + capability"
		},
		effort: "Max",
		strategy: {
			ru: "plan-execute + reflection + authority gate",
			en: "plan-execute + reflection + authority gate"
		},
		verifier: {
			ru: "intent guardian + receipts",
			en: "intent guardian + receipts"
		},
		privacy: {
			ru: "lease-bounded tools",
			en: "lease-bounded tools"
		},
		memory: {
			ru: "Continuum process state",
			en: "Continuum process state"
		},
		plane: "control",
		note: {
	...
	if (has("письм", "letter", "tone", "тон", "шутк", "юмор", "poem", "стих", "друг", "коллег")) return {
		role: {
			ru: "Interaction",
			en: "Interaction"
		},
		...
		effort: "Medium",
		strategy: {
			ru: "direct, calibrated",
			en: "direct, calibrated"
		},
		verifier: {
			ru: "sycophancy / honesty check",
			en: "sycophancy / honesty check"
		},
		privacy: {
			ru: "local-first interaction",
			en: "local-first interaction"
		},
		memory: {
			ru: "user model (warm)",
			en: "user model (warm)"
	...
	if (has("объясн", "explain", "ребён", "child", "teach", "прост", "понятн")) return {
		role: {
			ru: "Interaction + Reasoner",
			en: "Interaction + Reasoner"
		},
		family: {
			ru: "handoff, then interpret",
			en: "handoff, then interpret"
		},
		effort: "High",
		strategy: {
			ru: "semantic handoff → reason → human rewrite",
			en: "semantic handoff → reason → human rewrite"
		},
		verifier: {
			ru: "fidelity to original intent",
			en: "fidelity to original intent"
		},
		privacy: {
			ru: "local interaction, optional cloud reasoner",
			en: "local interaction, optional cloud reasoner"
		},
		memory: {
			ru: "user level + desired depth",
			en: "user level + desired depth"
		},
		plane: "interaction",
		note: {
	...
	return {
		...
		family: {
			ru: "capability default",
			en: "capability default"
		},
		effort: "Medium",
		strategy: {
			ru: "direct with uncertainty flags",
			en: "direct with uncertainty flags"
		},
		verifier: {
			ru: "light self-consistency, escalate if risk",
			en: "light self-consistency, escalate if risk"
		},
		privacy: {
			ru: "default local-first",
			en: "default local-first"
		},
		memory: {
			ru: "hot context only",
			en: "hot context only"
...
var readingLayers = [
	{
		...
		n: "01",
		name: {
			ru: "Cognitive blueprint",
			en: "Cognitive blueprint"
		},
		owner: {
			ru: "CLOS",
			en: "CLOS"
	...
	},
	{
		...
		n: "02",
		name: {
			ru: "Семантика и композиция",
			en: "Semantics and composition"
		},
		owner: {
			ru: "Native Kernel · Mentaury Kernel",
			en: "Native Kernel · Mentaury Kernel"
		},
		body: {
	...
	},
	{
		...
		n: "03",
		name: {
			ru: "Политика экосистемы",
			en: "Ecosystem policy"
		},
		owner: {
			ru: "Ecosystem Map · System OS",
			en: "Ecosystem Map · System OS"
		},
		body: {
	...
	},
	{
		...
		n: "04",
		name: {
			ru: "Профили реализации",
			en: "Implementation profiles"
		},
		owner: {
			ru: "Cognitive OS · текущие проекты",
			en: "Cognitive OS · current projects"
		},
		body: {
...
var antiDegradation = [
	{
		...
		body: {
			ru: "Рабочий контекст размывается по мере роста окна.",
			en: "Working context blurs as the window grows."
		}
	},
	{
		name: {
		...
		body: {
			ru: "Цель подменяется более удобной промежуточной.",
			en: "The goal is replaced by a more convenient intermediate."
		}
	},
	{
		name: {
		...
		body: {
			ru: "Повтор тех же шагов без смены стратегии.",
			en: "The same steps repeat without a strategy change."
		}
	},
	{
		name: {
		...
		body: {
			ru: "Модель проверяет себя тем же семейством.",
			en: "The model checks itself with the same family."
		}
	},
	{
		name: {
		...
		body: {
			ru: "Гипотеза попадает в память как факт.",
			en: "A hypothesis lands in memory as a fact."
		}
	},
	{
		name: {
		...
		body: {
			ru: "Согласие важнее истины и intent.",
			en: "Agreement outranks truth and intent."
		}
	},
	{
		name: {
			ru: "update regression",
			en: "update regression"
		},
		body: {
			ru: "Новый checkpoint стирает нужные human traits.",
			en: "A new checkpoint erases needed human traits."
		}
	}
];
var genomeScenarios = [
	{
		id: "coder",
		label: {
			ru: "+15% код · −20% presence",
			en: "+15% coding · −20% presence"
		},
		human: -20,
		tech: 15
	},
	{
		id: "voice",
		label: {
			ru: "+18% presence · −8% агентность",
			en: "+18% presence · −8% agency"
		},
		human: 18,
		tech: -8
	},
	...
	},
	{
		id: "regress",
		label: {
			ru: "регрессия обеих осей",
			en: "regression on both axes"
		},
		human: -14,
		tech: -10
	}
];
function admitRoles(human, tech) {
	const v = (n, admitAt, holdAt) => n >= admitAt ? "admit" : n <= holdAt ? "hold" : "review";
	return [
		{
			id: "interaction",
			name: {
...
var closFrontiers = [
	{
		name: {
			ru: "Coverage / possibility-space",
			en: "Coverage / possibility-space"
		},
		status: {
			ru: "REFINE / CROSSWALK",
			en: "REFINE / CROSSWALK"
	...
	{
		name: {
			ru: "Lossy representation",
			en: "Lossy representation"
		},
		status: {
			ru: "REFINE / FIXTURE",
			en: "REFINE / FIXTURE"
	...
	{
		name: {
			ru: "Reason-Typed Stopping",
			en: "Reason-Typed Stopping"
		},
		status: {
			ru: "MERGE / REFINE",
			en: "MERGE / REFINE"
	...
	{
		name: {
			ru: "Event Segmentation",
			en: "Event Segmentation"
		},
		status: {
			ru: "DISTINCT QUESTION · не primitive",
			en: "DISTINCT QUESTION · not a primitive"
		}
	}
];
var dualPolicies = [{
